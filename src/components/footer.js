    ...
    >
      <div className="footer-max-width max-content-container">
        <div className="footer-container">
          <img
            alt="image"
            src="https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/127a250e-7417-4827-a461-64fff661e938/a0ef4872-e5a5-480f-8184-693b48008576?org_if_sml=14928"
            className="footer-image"
          />
          <span className="footer-text">
            <span className="footer-text1">
              The Online Learning Platform where We don&apos;t just Educate, 
            </span>
            <span className="footer-text2">We Elevate!</span>
            <br className=""></br>
          </span>
